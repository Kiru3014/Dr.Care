   ...
   //Invegation
    ...
    private void Agents() {
        ...
        if(pat_data.getSedationagent1().equalsIgnoreCase("others"))
            ...
            msagentone.setText(getseditionname(pat_data.getSedationagent1()));

        if(pat_data.getSedationagent2().equalsIgnoreCase("others"))
            msagentwo.setText(pat_data.getSedationAgent2Others());
        else
            msagentwo.setText(getseditionname(pat_data.getSedationagent2()));

        if(pat_data.getSedationagent3().equalsIgnoreCase("others"))
            msagentthree.setText(pat_data.getSedationAgent3Others());
        else
            msagentthree.setText(getseditionname(pat_data.getSedationagent3()));

        if(pat_data.getSedationagent4().equalsIgnoreCase("others"))
            msagentfour.setText(pat_data.getSedationAgent4Others());
        else
            msagentfour.setText(getseditionname(pat_data.getSedationagent4()));

        if(pat_data.getSedationagent5().equalsIgnoreCase("others"))
            msagentfive.setText(pat_data.getSedationAgent5Others());
        else
            msagentfive.setText(getseditionname(pat_data.getSedationagent5()));




        mdoseone.setText(pat_data.getInotropesDose1Value() +" "+getunitname(pat_data.getInotropesdose1()));
        mdosetwo.setText(pat_data.getInotropesDose2Value() +" "+getunitname(pat_data.getInotropesdose2()));
        mdosethree.setText(pat_data.getInotropesDose3Value() +" "+getunitname(pat_data.getInotropesdose3()));
        mdosefour.setText(pat_data.getInotropesDose4Value() +" "+getunitname(pat_data.getInotropesdose4()));
        mdosefive.setText(pat_data.getInotropesDose5Value() +" "+getunitname(pat_data.getInotropesdose5()));

        msdoseone.setText(pat_data.getSedationDose1Value()+" "+getunitname(pat_data.getSedationdose1()));
        msdosewo.setText(pat_data.getSedationDose2Value()+" "+getunitname(pat_data.getSedationdose2()));
        msdosethree.setText(pat_data.getSedationDose3Value()+" "+getunitname(pat_data.getSedationdose3()));
        msdosefour.setText(pat_data.getSedationDose4Value()+" "+getunitname(pat_data.getSedationdose4()));
        msdosefive.setText(pat_data.getSedationDose5Value()+" "+getunitname(pat_data.getSedationdose5()));
